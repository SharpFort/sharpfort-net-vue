<template>
  <div
    class="ai-tool-container h-[calc(100vh-80px)] w-full flex flex-col p-6 overflow-hidden bg-slate-50 dark:bg-slate-900 !text-slate-800 dark:!text-slate-200"
  >
    <!-- Header Area -->
    <div class="flex items-center justify-between mb-6">
      <div class="flex items-center gap-3">
        <div
          class="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-indigo-500 shadow-md flex items-center justify-center text-white"
        >
    ...
    <!-- Main Content Area -->
    <div
      class="flex-1 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700/50 p-6 overflow-y-auto"
    >
          ...
          <div class="max-w-2xl mt-4">
            <el-form label-position="top">
              ...
              <el-form-item label="目标语言" required>
                <el-input
                  v-model.trim="translateForm.targetLang"
                  placeholder="例如: 英文, 日语, 繁体中文"
                />
              </el-form-item>

              <el-form-item label="待翻译文本" required>
                <el-input
                  v-model.trim="translateForm.text"
                  type="textarea"
                  :rows="4"
              ...
              <div
                v-if="results.translate"
                class="mt-6 p-4 bg-slate-50 dark:bg-slate-900 rounded-lg border border-slate-100 dark:border-slate-700 whitespace-pre-wrap"
              >
                {{ results.translate }}
              </div>
            </el-form>
          ...
          <div class="max-w-2xl mt-4">
            <el-form label-position="top">
              ...
              <el-form-item label="待总结内容" required>
                <el-input
                  v-model.trim="summarizeForm.content"
                  type="textarea"
                  :rows="6"
          ...
          <div class="max-w-2xl mt-4">
            <el-form label-position="top">
              ...
              <div class="mt-2" v-if="loading.search">
                <el-text type="info"
                  ><el-icon class="is-loading mr-1"><Loading /></el-icon> 正在为您检索...</el-text
                >
              </div>
